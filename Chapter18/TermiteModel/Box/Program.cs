    ...
    internal static class Program
    {
        ...
        private static void Main()
        {
            try
            {
                ...
                ServiceRuntime.RegisterServiceAsync("BoxType",
                    context => new Box(context)).GetAwaiter().GetResult();

                ServiceEventSource.Current.ServiceTypeRegistered(Process.GetCurrentProcess().Id, typeof(Box).Name);
